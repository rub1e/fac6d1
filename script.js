var typeInput = document.getElementById('t-type'); var intInput = 11; var enjInput = 11; var lenInput = document.getElementById('t-length'); var noteInput = document.getElementById('t-notes'); var injInput = document.getElementById('t-injuries'); var goalInput = document.getElementById('t-goals'); document.querySelector('form.train-form').addEventListener('submit', function(e) {
  e.preventDefault();
